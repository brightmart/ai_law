...
class HierarchicalAttention:
    def __init__(self,  accusation_num_classes,article_num_classes, deathpenalty_num_classes,lifeimprisonment_num_classes,learning_rate,
        ...
        self.input_feature = tf.placeholder(tf.float32, [batch_size, self.feature_length], name="input_feature")
    ...
    def inference_text_cnn(self):# RNN-->CNN-->NN-->Classifier
        ...
        h_feature = tf.layers.dense(self.input_feature, self.hidden_size/4, activation=tf.nn.relu, use_bias=True) #[batch_size, hidden_size/4]<---[batch_size,feature_length]
