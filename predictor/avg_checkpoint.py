...
flags.DEFINE_string("checkpoints", "model.ckpt-4,model.ckpt-5,model.ckpt-6,model.ckpt-10c",
                    "Comma-separated list of checkpoints to average.")
flags.DEFINE_integer("num_last_checkpoints", 20,
                     "Averages the last N saved checkpoints."
                     " If the checkpoints flag is set, this is ignored.")
flags.DEFINE_string("prefix", "./checkpoint/",
                    "Prefix (e.g., directory) to append to each checkpoint.")
flags.DEFINE_string("output_path", "./checkpoint/averaged.ckpt",
